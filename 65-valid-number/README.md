<h2><a href="https://leetcode.com/problems/valid-number">Valid Number</a></h2> <img src='https://img.shields.io/badge/Difficulty-Hard-red' alt='Difficulty: Hard' /><hr><p>A <strong>valid number</strong> can be split up into these components (in order):</p>
